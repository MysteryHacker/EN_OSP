...
{     
     try
     {
       ...
       System.out.println("times and average WT and TAT for each entered process according to non-preemptive SJF algorithm.\n\n");
    ...
    //Here the processes ArrayList will be sorted by ascending order such that it imitates 
    //the execution time line of the processes in non-preemptive SJF algorithm.   
     Collections.sort(process, Process.process_burst_time_comparator);
